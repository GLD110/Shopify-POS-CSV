...
if( ENVIRONMENT == 'development'){
  $config['base_url']  = 'http://localhost:9080/shopify-pos/';
  $config['app_path']    = 'D:/www/Git/Shopify-POS-CSV/';
}
...
// APP Configuration
$config['APP_NAME'] = 'Shopify POS CSV';
$config['APP_CLIENT_ID'] = '';          // API KEY
$config['APP_CLIENT_SECRET'] = '';      // Credential
$config['APP_SCOPE'] = '';
